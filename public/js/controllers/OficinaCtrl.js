angular.module('OficinaCtrl',[])

	.controller('OficinaController', ['$rootScope','$scope','$routeParams','$location','Main','Oficinas', function($rootScope, $scope, $routeParams, $location, Main, Oficinas) {
